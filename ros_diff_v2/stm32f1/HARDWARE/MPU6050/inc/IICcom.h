/******************************************************************************
 * @file    IICcom.h
 * @brief   Simulated I2C GPIO interface declarations for the MPU6050 driver.
 * @author  User
 * @date    2026-05-19
 * @version V1.0.0
...
#define SCL_H         HAL_GPIO_WritePin(GPIOA,GPIO_PIN_6,GPIO_PIN_SET)//GPIOA->BSRR = GPIO_PIN_6 
#define SCL_L         HAL_GPIO_WritePin(GPIOA,GPIO_PIN_6,GPIO_PIN_RESET)
   
#define SDA_H         HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7,GPIO_PIN_SET)
#define SDA_L         HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7,GPIO_PIN_RESET)

#define SCL_read      HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_6)//GPIOA->IDR  & GPIO_PIN_6
#define SDA_read      HAL_GPIO_ReadPin(GPIOA,GPIO_PIN_7)
